...
export default class Items extends Component {
  ...
  render() {
    ...
    const ScrollViewComp = customScrollViewComp
      ...
      : ScrollView
    return (
      <View style={[styles.container, { top: positionY, left: positionX }, this.props.style]}>
        <ScrollViewComp
          style={{ width: this.props.style.width ? this.props.style.width : width, height: autoHeightItemsList && items.length < 3 ? 'auto' : height * 3 }}
